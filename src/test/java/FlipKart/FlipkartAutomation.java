...
public class FlipkartAutomation {
    ...
    public void testcase() throws InterruptedException {
        ...
        //..w.ait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.androidUIAutomator("new UiScrollable(new uiSelector)).ScrollIntoView(new UiSelector().text(\"APPLE iPhone 13 (Starlight, 256 GB)\"))")));
        Thread.sleep(2000);
